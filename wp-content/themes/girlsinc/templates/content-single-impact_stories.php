<?php while (have_posts()) : the_post(); ?>
    ...
    <article <?php post_class($spotlight === true ? 'spotlight' : ''); ?>>

        <header class="row">
            <div class="col-12 text-center">
                <strong class="text-primary"><?php if($label){echo $label[0]->name; }else{ echo ($spotlight === true) ? 'Spotlight' : 'Impact Story'; } ?></strong>
                <h1 class="entry-title"><?php the_title(); ?></h1>
                <div class="story-hr"></div>
